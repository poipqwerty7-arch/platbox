...
@onready var create_button: Button = $Margin/VBox/TopBar/CreateButton
...
func _on_create_pressed() -> void:
	get_tree().change_scene_to_file("res://scenes/editor/my_projects.tscn")
...
func _on_play_pressed(game_id) -> void:
	var id_str := str(game_id)
	Session.fetch_level(id_str, func(level_data):
		Session.pending_level_data = level_data
