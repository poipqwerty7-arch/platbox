...
func _ready() -> void:
	...
	$Toolbar/SelectTool.pressed.connect(func(): tool_selected.emit(0))
	$Toolbar/MoveTool.pressed.connect(func(): tool_selected.emit(1))
	$Toolbar/RotateTool.pressed.connect(func(): tool_selected.emit(2))
	$Toolbar/ScaleTool.pressed.connect(func(): tool_selected.emit(3))
...
func is_mouse_over_ui() -> bool:
	...
	for panel in [inspector_panel, $Palette, $Toolbar, $BottomBar]:
